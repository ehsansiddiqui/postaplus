        ...
        <div class="container clearfix">
          <div class="col_full">
            ...
            <div class="content_center">
              <h3 class="sub_head"> SUMMERY </h3>

              <form class="default-form" id="form_id"action="<?=site_url('summery/order')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <select name="class_id" class="form-control" id="class_id" onchange="b();" required>
                ...
                <div class="form-group">
                    <select name="summary_id"  class="form-control" id="classes_name" required> 
...
<script>
    ...
    function printing(){
        ...
        var brand_id = e.options[e.selectedIndex].value;
            ...
            $.ajax({
            url: '<?=site_url('summery/get_summery')?>',
            type: 'GET',
            data: {class_id: class_id,brand_id: brand_id}, 
            dataType: 'json',      
            ...
            {   
                 ...
                 if(msg.status == '200'){
                   $.each(msg.res, function(index, value){
                       $print_type +='<option value="'+value.summary_id+'" selected>'+value.summary_tittle+'</option>';
                    });            
    ...
    function b(){
        ...
        var class_id = e.options[e.selectedIndex].value;
       ...
       // alert(class_id);
            ...
            {   
               // alert(msg);
                 ...
                 if(msg.status == '200'){
                   $.each(msg.res, function(index, value){
                       $brand +='<option value="'+value.summary_id+'" selected>'+value.summary_tittle+'</option>';
                    });            
                   $("#classes_name").html($brand);
                  }  
