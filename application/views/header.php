   ...
   <input type="password" name="password" class="form-control" id="password" placeholder="Password" required="">
    ...
    <input type="text" name="full_name" class="form-control" id="full_name" placeholder="Name">
        ...
        <div class="user-section">
            <div class="btn-group">
                <a style="font-size:30px;padding: 10px;" href="<?=site_url('cart/index')?>"><i class="fa fa-shopping-cart"></i></a>
...
<!--                <button class="dropdown-item" type="button"> Share with friends </button>
        ...
        ============================================= -->
                  ...
                  <a href="<?=site_url('language/ar')?>" style="color:#444; font-size:20px;">عربي</a>
                  </div>
                        <!-- Primary Navigation
        ============================================= -->
...
<!--                                            <li>
    ...
    -->
                            ...
                            <li <?php if ($this->uri->segment(1) == 'services') { ?> class="active"<?php } ?>>
