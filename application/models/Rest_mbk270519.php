...
//    AD.attributes_id";
	...
	return $this->db->insert_id();
     ...
     $sql = "SELECT p.photoprinting_id,p.attributes_id,p.price,ad.atr_name as attributes_name FROM photoprinting p , attributes ad WHERE  p.attributes_id = ad.attributes_id";

         }else{

             

     $sql = "SELECT p.photoprinting_id,p.attributes_id,p.price,ad.ar_atr_name as attributes_name FROM photoprinting p , attributes ad WHERE  p.attributes_id = ad.attributes_id";
	...
	function get_others($language_id)
		...
		//$this->db->order_by('print_type_name', 'ASC');
                ...
                $this->db->select('o.others_id,o.others_tittle,o.others_description,o.others_image');
                 ...
                 $this->db->select('o.others_id,o.ar_others_tittle as others_title,o.ar_others_description as others_description ,o.others_image');   
                }
...
return $query->result(); 
    ...
    public function get_branch($language_id){
        ...
        if($language_id == 2){
            ...
            $this->db->select('branch_id,branch_name_ar as branch_name');
