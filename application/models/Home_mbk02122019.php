...
LEFT JOIN user u ON (u.user_id = o.user_id) LEFT JOIN branch b ON (b.branch_id = o.branch_id) LEFT JOIN order_status os ON (os.order_status_id = o.status) WHERE o.user_id = $user_id AND o.payment_status = 'paid'";  
