...
$data = array('payment_id'=>$PaymentID,'trackid'=>$trackid,'order_id'=>$udf1,'ref'=>$ref,'result'=>$result,'date'=>$date,'amt'=>$amount);
$CI->db->insert('payment',$data);
