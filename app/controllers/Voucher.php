...
//              $created =  date('Y-m-d',strtotime($this->input->post('expiry_date')));
                ...
                $data = array('voucher_code' => $this->input->post('voucher_code'), 'voucher_desc' => $this->input->post('voucher_desc'), 'created_date' => $date,'voucher_type' => $this->input->post('voucher_type'), 'voucher_reduction' => $this->input->post('voucher_reduction'), 'minimum_amount' => $this->input->post('minimum_amount'),'expiry_date' => $expiry, 'user_flag' => $user_flag);
