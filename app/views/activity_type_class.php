     ...
     <a href="<?=site_url('activity_type/add_class_activity')?>"><i class="fa fa-plus icon-bk"></i></a>
...
<!--                                                 <td><?=$row->activity_description;?></td>-->
                                                  <td>
                                                <a href="<?php echo site_url('activity_type/edit_class_activity/' . $row->studio_activity_acitivity_id.'/'.$row->activity_id) ?>" title="edit"><i class="fa fa-edit"></i></a>
                                                
                                                    <a href="<?php echo site_url('activity_type/delete_class_activity/' . $row->studio_activity_acitivity_id.'/'.$row->activity_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')" title="delete"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
