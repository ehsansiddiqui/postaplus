     ...
     <a href="<?=site_url('location/add_location')?>"><i class="fa fa-plus icon-bk"></i></a>
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                 <td><?=$i?></td>
                                                 <td><?=strtoupper($row->location_name);?></td>

                                                
                                           <td>   <a href="<?php echo site_url('location/edit_location/' . $row->location_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('location/delete_location/' . $row->location_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
