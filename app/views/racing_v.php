                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">RACING DETAILS</h3>&nbsp;
                                    
<!--     <a href="<?=site_url('racing/add')?>"><i class="fa fa-plus icon-bk"></i></a>-->
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$i?></td>
                                                <td><?=$row->racing_name;?></td> 
     <td>

<!--<a href="<?php echo site_url('events/edit_events/' . $row->racing_id) ?>"><i class="fa fa-edit"></i></a>-->
                              <a href="<?php echo site_url('racing/delete/' . $row->racing_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
