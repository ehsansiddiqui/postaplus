     ...
     <a href="<?=site_url('branch/add')?>"><i class="fa fa-plus icon-bk"></i></a>
                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$row->branch_name_ar;?></td>
                                                <td><?=$row->phone_number;?></td>
                                                <td><?=$row->branch_email;?></td>

<td>
    <a href="<?php echo site_url('branch/edit/'.$row->branch_id) ?>" title="edit"><i class="fa fa-edit"></i></a>
         <a href="<?php echo site_url('branch/delete/'.$row->branch_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')" title="delete"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
