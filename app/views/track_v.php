     ...
     <a href="<?=site_url('track/add')?>"><i class="fa fa-plus icon-bk"></i></a>
...
<!--                                        <li><a href="#" onClick ="$('#customers2').tableExport({type:'png',escape:'false'});"><img src='<?=base_url()?>assets/img/icons/png.png' width="24"/> PNG</a></li>-->
      ...
      <td>
<!--<a href="<?php echo site_url('events/edit_events/' . $row->track_id) ?>"><i class="fa fa-edit"></i></a>-->
<a href="<?php echo site_url('track/delete/' . $row->track_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a>
      </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
