                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">RACING TYPE</h3>&nbsp;
                                    
<!--     <a href="<?=site_url('car/add')?>"><i class="fa fa-plus icon-bk"></i></a>-->
...
<!--                                                <td><?=$row->car_name;?></td>-->
                                                <td><?=$row->car_model;?></td>
                 <td><img src="<?=base_url()?>car/<?=$row->car_thumb_img?>" width="100" height="50"/></td>
                 <td><a href="<?php echo site_url('car/view_more/' . $row->car_id) ?>">view more</a></td>
                                                
                                            <td>
<!--<a href="<?php echo site_url('car/edit/' . $row->car_id) ?>"><i class="fa fa-edit"></i></a>-->
  <a href="<?php echo site_url('car/delete/' . $row->car_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> 
                                            </td>
