  ...
  <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('event_type/edit_1/'.$id) ?>" method="post">
                                <div class="panel-body">
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Event Type:</label>  
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="event_type" value="<?=$result->event_type_name?>" required/>
...
<!--                                  <button class="btn btn-primary" type="submit">Submit</button>-->
  ...
  <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('event_type/add/') ?>" method="post">
<!--                                <div class="panel-body">
