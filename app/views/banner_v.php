     ...
     <a href="<?=site_url('banner/add_banner')?>"><i class="fa fa-plus icon-bk"></i></a>
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$i?></td>
                                                <td><?=$row->banner_tittle;?></td>
                                                <td><?= substr($row->banner_description,0,50);?></td>
               <td><img src="<?=base_url()?>assets/udayamotors/images/banner/<?=$row->banner_image?>" width="100" height="50" /></td>
                                                
                                           <td><a href="<?php echo site_url('banner/edit_banner/' . $row->banner_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('banner/delete_banner/' . $row->banner_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
