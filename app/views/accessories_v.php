        ...
        <div class="col-md-12"> 
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><?= strtoupper('accessories') ?></h3>&nbsp;

                    <a href="<?= site_url('accessories/add_accessories') ?>"><i class="fa fa-plus icon-bk"></i></a>
                        ...
                        <tbody>
                            <?php if ($result) {
                                ...
                                foreach ($result as $row): ?>   
                                    <tr>
                                        <td><?= $i ?></td>
                                        <td><?= $row->accessories_type_name; ?></td>
                                        <td><?= $row->short_title; ?></td>
                                        <td><img src="<?= base_url() ?>assets/udayamotors/images/shop/accessories/<?= $row->anchor_image ?>" width="100" height="50" /></td>

                                        <td><a href="<?php echo site_url('accessories/edit_accessories/' . $row->accessories_id) ?>"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo site_url('accessories/delete_accessories/' . $row->accessories_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                    </tr>
        <?php $i++;
    endforeach;
} ?>
