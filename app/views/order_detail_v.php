...
<!--                            <tr>
                        ...
                        <tbody>
                           ...
                           <?php $email_order_ = $result->email_id; ?>
                            <tr>
...
<!--                            <tr>
              ...
              <td> <a href="<?=base_url().'user/'.$result->printing_file;?>" target="blank">View File </a> </td>
                        ...
                        <?php } ?>
                            ...
                            <tr>
                                <td><strong>Assign To Branch</strong></td>
                                <td>   
                <select class="form-control select" name="branch_id" id="branch_id" data-live-search="true" required>
                    <option value="">Choose Branch </option>
                                        <?php foreach ($branch as $row): ?>
                <option value="<?= $row->branch_id ?>" 
                    <?php if ($row->branch_id == $result->branch_id) {
                                                echo 'selected';
                                            }
                                            ?>><?= $row->branch_name ?>
                </option>
...
<!--      <div class="modal-body">-->
    ...
    <?php endforeach; ?>
                   ...
                   <input type="hidden" name="email_order_" value="<?php echo $email_order_ ?>">
                                </div>
                            </div>
...
{	
	...
	{  
		var branch_id = $(this).find(":selected").val();
                var order_id =  $("#order_id").val();
                
                $.ajax
		({      type: "POST",
			url: '<?=site_url('order/assign_branch')?>',
                    	data: {branch_id:branch_id,order_id:order_id},
			cache: false,
			success: function(r)
			{
                           //$("#success").html(r);
