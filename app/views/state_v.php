     ...
     <a href="<?=site_url('state/add_state')?>"><i class="fa fa-plus icon-bk"></i></a>
...
<!--                                            <li><a href="#" onClick ="$('#customers2').tableExport({type:'json',escape:'false'});"><img src='<?=base_url()?>assets/img/icons/json.png' width="24"/> JSON</a></li>
         ...
         <td><a href="<?php echo site_url('state/edit_state/'.$row->state_id)?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('state/delete_state/'.$row->state_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
