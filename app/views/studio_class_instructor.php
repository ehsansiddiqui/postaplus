        ...
        <div class="col-md-12"> 
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="<?= site_url('instructor/insert_studio_class_instructor') ?> "><i class="fa fa-plus icon-bk"></i></a>
...
-->                                       <td>
                                    <a href="<?php echo site_url('instructor/edit_studio_class_instructor/' . $row->studio_instructor_id.'/'.$row->instructor_id) ?>"><i class="fa fa-edit"></i></a>
                                    <a href="<?php echo site_url('instructor/delete_studio_class_instructor/' . $row->studio_instructor_id.'/'.$row->instructor_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> 
                                          </td>
