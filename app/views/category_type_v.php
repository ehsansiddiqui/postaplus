     ...
     <a href="<?=site_url('vehicle/add_category_type')?>"><i class="fa fa-plus icon-bk"></i></a>
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                           ...
                                           <td>   <a href="<?php echo site_url('vehicle/edit_category_type/' . $row->category_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('vehicle/delete_category_type/' . $row->category_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
