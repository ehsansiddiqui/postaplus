...
<!--     <a href="<?=site_url('events/add_events')?>"><i class="fa fa-plus icon-bk"></i></a>-->
...
<!--                                               <td><?= substr($row->description,0,50);?></td>                    
    <td><img src="<?=base_url()?>assets/udayamotors/images/shop/events/<?=$row->image?>" width="100" height="50" /></td>                                    -->

         
      <td>
<!--          <a href="<?php echo site_url('events/edit_events/' . $row->event_id) ?>"><i class="fa fa-edit"></i></a>-->
                              <a href="<?php echo site_url('events/delete_events/' . $row->event_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
