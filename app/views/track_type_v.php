                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Track TYPE</h3>&nbsp;
                                    
     <a href="<?=site_url('track_type/add')?>"><i class="fa fa-plus icon-bk"></i></a>
  ...
  <td><a href="<?php echo site_url('track_type/edit/' . $row->track_type_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('track_type/delete/' . $row->track_type_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
