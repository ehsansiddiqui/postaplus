...
<div class="page-content-wrap">                
        ...
        <div class="col-md-6">                        
            ...
            <?php if (@$id != NULL) { ?>
                ...
                <div class="block">
                    ...
                    <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('accountant/edit_1/'. $id) ?>"  enctype="multipart/form-data" method="post">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
             <input type="text" class="form-control" name="accountant_name" value="<?=$res->accountant_name?>"  maxlength="255" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
             <input type="text" class="form-control" name="accountant_name_ar" dir="rtl" value="<?=$res->accountant_name_ar?>"  maxlength="255" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
        <input type="email" class="form-control" name="email"  value="<?=$res->accountant_email?>"  maxlength="255" required />
                                </div>
                            </div>
             ...
             <input type="text" class="form-control" name="address" value="<?=$res->address?>"  maxlength="255" required/>
                ...
                <input type="text" class="form-control" name="google_map_url" value="<?=$res->google_map_url?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                        <img src="<?=base_url()?>accountant/<?=$res->accountant_image?>" width="100" height="50"/>        
                                </div>
                            </div>
 ...
 <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('accountant/add') ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Tittle :</label>  
                                <div class="col-md-9">
             <input type="text" class="form-control" name="accountant_name"   maxlength="255" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Arabic Tittle :</label>  
                                <div class="col-md-9">
             <input type="text" class="form-control" name="accountant_name_ar" dir="rtl"  maxlength="255" required/>
                                </div>
                            </div>
