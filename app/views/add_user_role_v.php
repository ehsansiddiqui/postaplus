  ...
  <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('user_role/edit_1/'.$id) ?>" method="post">
                                <div class="panel-body">
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Event Type:</label>  
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="user_role" value="<?=$result->user_role_name?>" required/>
...
<!--                                  <button class="btn btn-primary" type="submit">Submit</button>-->
      ...
      <div class="block">
       <h4>ADD USER ROLE</h4>
  <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('user_role/add/') ?>" method="post">
<!--                                <div class="panel-body">
