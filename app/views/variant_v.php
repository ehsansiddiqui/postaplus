                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">VEHICLE VARIANT</h3>&nbsp;
                                    
     <a href="<?=site_url('variant/add_variant')?>"><i class="fa fa-plus icon-bk"></i></a>
...
<!--                                            <li><a href="#" onClick ="$('#customers2').tableExport({type:'json',escape:'false'});"><img src='<?=base_url()?>assets/img/icons/json.png' width="24"/> JSON</a></li>
         ...
         <td><a href="<?php echo site_url('variant/edit_variant/'.$row->vehicle_variant_id)?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('variant/delete_variant/'.$row->vehicle_variant_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
