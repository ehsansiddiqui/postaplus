...
<div class="page-content-wrap">
    <div class="row">
        ...
        <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('order/new_order') ?>" method="post">
         ...
         <td><input type="text"  maxlength="50"  class="form-control" name="order_number" id="order_number"/></td>
                            </tr> 
 ...
 <td><input type="text"  maxlength="50"  class="form-control" name="phone_number" id="phone_number"  readonly style="color: black;"/></td>
    ...
    <?php endforeach; ?>
                       ...
                       <td><input type="text" class="form-control datepicker" name="order_date"   required/></td>                                      
                            </tr>


                             <tr>
                            <td><strong>Pickup Date</strong></td>  
                       <td><input type="text" class="form-control datepicker" name="pickup_date" required/></td>                                      
                            </tr>
                            
                            <tr>     
                            <td><strong>Scheduled Date</strong></td>              
            <td><input type="text" class="form-control datepicker" name="scheduled_date" required/></td>   
                            </tr>
                    ...
                    <table id="customers2" class="table">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" name="payment_method" value="1" checked/> CASH
                                </td>
                            </tr>
