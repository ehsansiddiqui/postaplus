       ...
       function getradio(){
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group" id="head" style="display:none;">    
                                    ...
                                    <div class="col-md-9">                                                                            
                                        <select multiple class="form-control select" name="user_id[]" data-live-search="true" required>
        ...
        <?php endforeach; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">                                                                            
                                        <select  class="form-control select" name="voucher_type" value="<?= $result->voucher_type ?>" required>
                                            ...
                                            <option value="1" <?php if ($result->voucher_type == 1) { ?> selected="" <?php } ?> >Percentage Reduction</option>
                                            <option value="2" <?php if ($result->voucher_type == 2) { ?> selected="" <?php } ?>>Price Reduction</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="created_date" value="<?= $result->created_date ?>" data-multiple-dates="18250" data-multiple-dates-separator=", "  data-language="en" class="form-control datepicker-here" required>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="expiry_date" value="<?= $result->expiry_date ?>" data-multiple-dates="18250" data-multiple-dates-separator=", "  data-language="en" class="form-control datepicker-here" required>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                        ...
                        <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo site_url('voucher/add/') ?>" method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group" id="head" style="display:none;">
                                    ...
                                    <label class="col-md-3 control-label">User :</label>
                                    <div class="col-sm-9">                                                                            
                                        <select multiple class="form-control select" id="user_id" style="display:none;" name="user_id[]" data-live-search="true" required>
        ...
        <?php endforeach; ?>
                                ...
                                <!--                            
                                                            <div class="form-group">
                                                                        <label class="col-md-3 control-label">Studio :</label>
                                                                        <div class="col-md-9">                                                                            
                                                                        <select multiple class="form-control select" name="studio_id[]" data-live-search="true" required>
                                <?php foreach ($studio as $row): ?>
                                                   <option value="<?= $row->studio_id ?>"><?= $row->studio_name ?></option>
        <?php endforeach; ?>
                                                                        </select>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Created Date:</label>  
                                    <div class="col-md-9">
                                        <input type="text" name="created_date"  data-multiple-dates="18250" data-multiple-dates-separator=", "  data-language="en" class="form-control datepicker-here" required>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Expiry Date:</label>  
                                    <div class="col-md-9">
                                        <input type="text" name="expiry_date"  data-multiple-dates="18250" data-multiple-dates-separator=", "  data-language="en" class="form-control datepicker-here" required>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
