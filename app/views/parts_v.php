     ...
     <a href="<?=site_url('parts/add_parts')?>"><i class="fa fa-plus icon-bk"></i></a>
                                    ...
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$row->parts_type_name;?></td>
                                                <td><?=$row->short_title;?></td>
         <td><img src="<?=base_url()?>assets/udayamotors/images/shop/parts/<?=$row->anchor_image?>" width="100" height="50" /></td>
                                          
                                       <td><a href="<?php echo site_url('parts/edit_parts/' . $row->parts_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('parts/delete_parts/' . $row->parts_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
