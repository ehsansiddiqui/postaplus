...
<div class="page-content-wrap">                
    <div class="row">
        <div class="col-md-6">                        
            ...
            <?php if (@$studio_instructor_id != NULL) { ?>

                <div class="block">
                    <h4>EDIT CLASS INSTRUCTOR</h4>
                    <form id="form" role="form" class="form-horizontal" action="<?php echo site_url('instructor/update_studio_class_instructor/' . $studio_instructor_id . '/' . $instructor_id) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                   ...
                                   <a href="<?=site_url('instructor/disable_image/?instructor_id=' .$result->instructor_id)?>" <i class="fa fa-times-circle" aria-hidden="true" title="delete" style="position: absolute;top: -5px;right: 250px;z-index: 96;"></i></a>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Price Per Hour:</label>  
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="instructor_price_per_hour" value="<?= $result->instructor_price_per_hour ?>" required/>
                                    <span class="help-block"></span>
                                </div>
                            </div>
            ...
            <?php } else { ?>
                ...
                <div class="block">
                    ...
                    <form id="form" role="form" class="form-horizontal" action="<?php echo site_url('instructor/insert_studio_class_instructor') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Price Per Hour:</label>  
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="instructor_price_per_hour" required/>
                                    <span class="help-block"></span>
                                </div>
                            </div>
