...
<!--                            <tr>
 ...
 <td><input type="text"  maxlength="50"  class="form-control" name="phone_number" id="phone_number"  readonly style="color: black;"/></td>
    ...
    <?php endforeach; ?>
                       ...
                       <td><input type="text" class="form-control datepicker" name="pickup_date" value="<?= date('Y-m-d', strtotime($result->pickup_date)); ?>"  required/></td>                                      
                            </tr>
                            
                            <tr>     
                            <td><strong>Scheduled Date</strong></td>
                                
            <td><input type="text" class="form-control datepicker" name="scheduled_date" value="<?= date('Y-m-d', strtotime($result->scheduled_date)); ?>"  required/></td>                           
                            ...
                            <td><strong>Delivery Address</strong></td>
                             <td>
    <textarea class="form-control" rows="5" name="customer_address" readonly style="color: black;" id="customer_address"><?=$result->customer_address;?></textarea>
                             </td>
                            </tr>
...
<!--                                <th></th>
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td style="border-top: 0px"><?= $result->pickup_name; ?></td>
                            </tr>
