     ...
     <a href="<?=site_url('event_type/add')?>"><i class="fa fa-plus icon-bk"></i></a>
  ...
  <td><a href="<?php echo site_url('event_type/edit/' . $row->event_type_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('event_type/delete/' . $row->event_type_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
