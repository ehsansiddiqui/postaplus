     ...
     <a href="<?=site_url('user_role/add')?>"><i class="fa fa-plus icon-bk"></i></a>
  ...
  <td><a href="<?php echo site_url('user_role/edit/' . $row->user_role_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('user_role/delete/' . $row->user_role_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
