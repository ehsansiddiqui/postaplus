     ...
     <a href="<?=site_url('racing_type/add')?>"><i class="fa fa-plus icon-bk"></i></a>
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$i?></td>
                                                <td><?=$row->racing_type_name;?></td>
                                                
  <td><a href="<?php echo site_url('racing_type/edit/' . $row->racing_type_id) ?>"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo site_url('racing_type/delete/' . $row->racing_type_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> </td>
                                            </tr>
                                            <?php $i++; endforeach ; } ?>
                                        </tbody>
                                    </table>                                    
