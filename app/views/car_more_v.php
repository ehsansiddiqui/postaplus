...
<!--     <a href="<?=site_url('car/add')?>"><i class="fa fa-plus icon-bk"></i></a>-->
                 ...
                 <td><img src="<?=base_url()?>car/<?=$row->images?>" width="100" height="50"/></td>
            
                                                
                                            <td>
<!--<a href="<?php echo site_url('car/edit/' . $row->car_id) ?>"><i class="fa fa-edit"></i></a>-->
  <a href="<?php echo site_url('car/delete/' . $row->car_image_id) ?>" onclick="return confirm('Are  you sure you want to delete this ')"><i class="fa fa-trash-o"></i></a> 
                                            </td>
